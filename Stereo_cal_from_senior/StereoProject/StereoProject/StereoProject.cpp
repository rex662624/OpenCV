...
BEGIN_MESSAGE_MAP(CStereoProjectApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CStereoProjectApp 建構

CStereoProjectApp::CStereoProjectApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CStereoProjectApp 物件

CStereoProjectApp theApp;


// CStereoProjectApp 初始設定

BOOL CStereoProjectApp::InitInstance()
{
